...
```sh
./app/wg_customized/connect.sh \
    sandbox 34.130.185.253 \
    sandbox-51-wireguard_server-1 \
    s3_2-wireguard_client-1 \
    ssh \
    "sudo docker"
```
